/**
 * FILE: pharmacy.js
 * MÔ TẢ: API calls cho quản lý nhà thuốc
 * Bao gồm: đơn thuốc, kho thuốc, danh mục thuốc, thống kê
 */

import { privateApi, publicApi } from './axios';

// ============ API WORKFLOW ĐƠN THUỐC ============

/**
 * Lấy danh sách đơn thuốc theo trạng thái
 * @param {Object} params - Tham số lọc (status, date, etc.)
 * @returns {Promise} Danh sách đơn thuốc
 */
...
/**
 * Lấy danh sách đơn thuốc chờ cấp (API cũ)
 */
...
/**
 * Lấy danh sách danh mục thuốc (kháng sinh, giảm đau, v.v.)
...
/**
 * Xem danh sách thuốc công khai (cho bệnh nhân tham khảo)
 * @param {Object} params - Tham số tìm kiếm, lọc
 * @returns {Promise} Danh sách thuốc
 */
